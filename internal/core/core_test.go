...
func TestMetadata(t *testing.T) {
	expected := Metadata{
		Axis: []*Axis{
			{Annotation: "Inline", Min: 1, Max: 5, Samples: 3, Stride: 2, Unit: "unitless"},
			{Annotation: "Crossline", Min: 10, Max: 11, Samples: 2, Stride: 1, Unit: "unitless"},
			{Annotation: "Sample", Min: 4, Max: 16, Samples: 4, Stride: 4, Unit: "ms"},
		},
...
func TestSliceMetadata(t *testing.T) {
	...
	expected := SliceMetadata{
		...
		X:          Axis{Annotation: "Sample", Min: 4, Max: 16, Samples: 4, Stride: 4, Unit: "ms"},
		Y:          Axis{Annotation: "Inline", Min: 1, Max: 5, Samples: 3, Stride: 2, Unit: "unitless"},
