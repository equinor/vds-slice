...
public:
    ...
    std::uint32_t GetDimensionIndexOffset_a(int dimension) const;

    std::uint32_t GetDimensionIndexOffset_b(int dimension) const;
...
private:
    ...
    std::uint32_t m_dimensionIndexOffset_a[Dimensionality_Max];
    std::uint32_t m_dimensionIndexOffset_b[Dimensionality_Max];
